...
const CONTENT = {
  es: {
    ...
    workIntro: 'Cuatro problemas financieros abordados desde conversión, comportamiento y sistemas de interfaz.', open: 'Explorar caso completo', soon: 'Caso en desarrollo',
    ...
    projects: [
      ...
      { name: 'Vaca', tag: 'Social FinTech · Shared Wallet', desc: 'Fondo compartido para roommates que mueve el dinero antes del gasto y elimina la fricción de cobrar reembolsos.', visual: 'vaca', href: '/casos/vaca', chips: ['Product Strategy', 'Wallet UX', 'Design System'], overlay: { role: 'Product Concept', problem: 'Dividir la deuda no elimina el momento incómodo de cobrar.', contribution: 'Fondo prepagado, arquitectura financiera y flujo de ocho pantallas.' } }
    ]
  },
  en: {
    ...
    workIntro: 'Four financial problems approached through conversion, behavior and interface systems.', open: 'Explore full case', soon: 'Case in progress',
    ...
    projects: [
      ...
      { name: 'Vaca', tag: 'Social FinTech · Shared Wallet', desc: 'A shared fund for roommates that moves money before spending and removes the friction of collecting reimbursements.', visual: 'vaca', href: '/casos/vaca', chips: ['Product Strategy', 'Wallet UX', 'Design System'], overlay: { role: 'Product Concept', problem: 'Splitting debt does not remove the awkward moment of collecting it.', contribution: 'A prepaid fund, financial architecture and an eight-screen flow.' } }
    ]
  }
};
