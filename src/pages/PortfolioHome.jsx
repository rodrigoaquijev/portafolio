...
const CONTENT = {
  es: {
    ...
    bioDetail: 'Actualmente trabajo en Fahrenheit DDB para Préstamos de Libre Disponibilidad de BBVA Perú. Diseño jerarquías de información, módulos responsive y activos en Salesforce Marketing Cloud orientados a conversión.',
    about: 'Sobre mí', aboutTitle: 'Primero aprendí a evaluar riesgo. Ahora diseño decisiones financieras.',
    ...
    workIntro: 'Un caso profesional de UX para email y tres proyectos conceptuales sobre estados transaccionales, decisiones financieras y gastos compartidos.', open: 'Explorar caso completo', soon: 'Caso en desarrollo',
    ...
    projects: [
      { name: 'BBVA Perú', tag: 'Caso profesional · UX para email', desc: 'Una oferta distinta para cada cliente. Un email que debía funcionar para todos.', image: bbvaCover, href: '/casos/bbva', chips: ['UX para email', 'Compliance', 'SFMC'], overlay: { role: 'Product Designer / UX/UI Designer', problem: 'Cada cliente recibía una oferta variable que debía entenderse rápido y cumplir restricciones bancarias.', contribution: 'Jerarquía de información, módulos responsive y preparación de activos para Salesforce Marketing Cloud.' } },
      { name: 'Yape', tag: 'Proyecto conceptual · Estados transaccionales', desc: '¿Qué haces cuando Yape no puede confirmar si tu dinero llegó? Una propuesta para comunicar la espera y ofrecer una siguiente acción clara.', image: yapeCover, href: '/casos/yape', chips: ['Auditoría UX', 'Microcopy', 'Sistema de estados'], overlay: { role: 'UX/UI Designer', problem: 'Un estado sin confirmación puede llevar al usuario a repetir una transferencia o buscar ayuda.', contribution: 'Arquitectura propuesta de estados, expectativas y opciones de recuperación.' } },
      { name: 'Allpa', tag: 'Proyecto conceptual · Finanzas conductuales', desc: '¿Puede tu reloj hacerte pensar dos veces antes de pagar? Un concepto para mostrar el efecto de una compra sobre el flujo de caja antes de confirmarla.', image: allpaCover, href: '/casos/allpa', chips: ['watchOS', 'Economía conductual', 'UX de flujo de caja'], overlay: { role: 'Product Designer', problem: 'El impacto de una compra suele revisarse después del gasto, cuando ya no puede cambiar la decisión.', contribution: 'Intervención contextual propuesta para Apple Watch e iOS antes de confirmar el pago.' } },
      { name: 'Vaca', tag: 'Proyecto conceptual · Gastos compartidos', desc: 'Dividir la cuenta es fácil. Cobrarle a tus roommates no. Vaca propone reunir el dinero antes de pagar los gastos comunes.', visual: 'vaca', href: '/casos/vaca', chips: ['Estrategia de producto', 'UX de wallet', 'Flujo conceptual'], overlay: { role: 'Product Designer', problem: 'Dividir la deuda no elimina el momento incómodo de cobrar.', contribution: 'Definición conceptual de un fondo prepagado para cubrir gastos del hogar antes de que aparezca la deuda.' } }
    ]
  },
  en: {
    ...
    bioDetail: 'I currently work at Fahrenheit DDB on BBVA Peru’s personal-loan campaigns. I design information hierarchies, responsive modules and assets in Salesforce Marketing Cloud with conversion goals in mind.',
    about: 'About', aboutTitle: 'I first learned to assess risk. Now I design financial decisions.',
    ...
    workIntro: 'One professional email UX case and three conceptual projects about transaction states, financial decisions and shared expenses.', open: 'Explore full case', soon: 'Case in progress',
    ...
    projects: [
      { name: 'BBVA Peru', tag: 'Professional case · Email UX', desc: 'A different offer for every customer. One email that had to work for all of them.', image: bbvaCover, href: '/casos/bbva', chips: ['Email UX', 'Compliance', 'SFMC'], overlay: { role: 'Product Designer / UX/UI Designer', problem: 'Each customer received a variable offer that had to be understood quickly while meeting banking restrictions.', contribution: 'Information hierarchy, responsive modules and asset preparation for Salesforce Marketing Cloud.' } },
      { name: 'Yape', tag: 'Concept project · Transaction states', desc: 'What do you do when Yape cannot confirm whether your money arrived? A proposal for communicating the wait and offering a clear next action.', image: yapeCover, href: '/casos/yape', chips: ['UX audit', 'Microcopy', 'State system'], overlay: { role: 'UX/UI Designer', problem: 'An unconfirmed state can lead users to repeat a transfer or seek help.', contribution: 'A proposed architecture for states, expectations and recovery options.' } },
      { name: 'Allpa', tag: 'Concept project · Behavioral finance', desc: 'Can your watch make you think twice before paying? A concept that shows how a purchase affects cash flow before confirmation.', image: allpaCover, href: '/casos/allpa', chips: ['watchOS', 'Behavioral economics', 'Cash-flow UX'], overlay: { role: 'Product Designer', problem: 'The impact of a purchase is often reviewed after spending, when the decision can no longer change.', contribution: 'A proposed contextual intervention for Apple Watch and iOS before payment confirmation.' } },
      { name: 'Vaca', tag: 'Concept project · Shared expenses', desc: 'Splitting the bill is easy. Collecting from your roommates is not. Vaca proposes gathering the money before paying shared expenses.', visual: 'vaca', href: '/casos/vaca', chips: ['Product strategy', 'Wallet UX', 'Concept flow'], overlay: { role: 'Product Designer', problem: 'Splitting a debt does not remove the awkward moment of collecting it.', contribution: 'A concept for a prepaid fund that covers household expenses before debt appears.' } }
    ]
  }
};
