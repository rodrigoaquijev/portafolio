...
export const BBVA_CASE = defineCaseStudy({
  ...
  es: {
    ...
    challengeLabel: 'Contexto de negocio',
    ...
    behaviorLabel: 'Problema conductual',
    ...
    wireLabel: 'Wireframes y arquitectura',
    ...
    impactLabel: 'Impacto y medición',
  ...
  en: {
    back: 'Back to portfolio', eyebrow: 'BBVA Peru · Financial design · Salesforce Marketing Cloud',
    ...
    challengeLabel: 'Business context', challengeTitle: <>The campaign was not a piece. It was a <em>decision system.</em></>,
    ...
    behaviorLabel: 'Behavioral problem', behaviorTitle: <>Too much information was raising the <em>cost of deciding.</em></>,
    ...
    wireLabel: 'Wireframes and architecture', wireTitle: <>A reading sequence from <em>offer to evidence.</em></>,
    ...
    uiLabel: 'UI system', uiTitle: <>Modular in operation. <em>Editorial in hierarchy.</em></>,
    ...
    impactLabel: 'Impact and measurement', impactTitle: <>Impact is defined before it is <em>claimed.</em></>,
